...
3. Damn, can't redo the object, but can undo it, lol. (ah, it seems its yet another missed addon bug, but not fixed, the redo doesn't work at all, relaunching Blender..)
